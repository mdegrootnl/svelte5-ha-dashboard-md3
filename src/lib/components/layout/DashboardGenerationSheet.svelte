<script lang="ts">
    ...
    function formatCardTypeLabel(cardType: DashboardCardType) {
        const labels: Partial<Record<DashboardCardType, string>> = {
            ...
            presence: dg("cardType.presence"),
            security: dg("cardType.security"),
            lock: dg("cardType.lock"),
            cover: dg("cardType.cover"),
            air: dg("cardType.air"),
            update: dg("cardType.update"),
            todo: dg("cardType.todo"),
            vacuum: dg("cardType.vacuum"),
            camera: dg("cardType.camera"),
